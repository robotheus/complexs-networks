...
def create_networks(n, p, k, nb, m):
    for x in range(1,10):
        ...
        nx.write_gml(graph_erdos,    "graphs/erdos/erdos_p=" + str(p))
        nx.write_gml(graph_watts,    "graphs/watts/watts_p=" + str(p))
        nx.write_gml(graph_barabasi, "graphs/barabasi/barabasi_n=" + str(nb))
